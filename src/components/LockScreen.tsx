          ...
          <div className="bg-gradient-to-br from-white via-slate-50 to-slate-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 max-w-sm w-full space-y-4 shadow-2xl text-left text-slate-900 dark:text-white">
            ...
            <div>
              <h3 className="text-base font-bold text-slate-900 dark:text-white">
                Restablecer Bloqueo de Pantalla
              </h3>
              <p className="text-xs text-slate-500 dark:text-slate-400 mt-1 leading-relaxed">
                Como FinanTrack opera de forma local y privada en tu navegador, puedes restablecer el bloqueo de pantalla en cualquier momento. Al hacerlo se desactivará el PIN y el desbloqueo biométrico para que puedas volver a acceder a tus finanzas y fijar un nuevo PIN cuando lo desees. Tus transacciones y cuentas no se borrarán.
              </p>
            </div>
            ...
            <div className="flex gap-2 pt-2">
              <button
                type="button"
                onClick={() => setShowForgotModal(false)}
                className="flex-1 py-2.5 px-3 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-xs font-bold text-slate-700 dark:text-slate-300 transition-colors"
              >
                Cancelar
              </button>
              <button
                ...
                className="flex-1 py-2.5 px-3 rounded-xl bg-amber-500 hover:bg-amber-600 text-xs font-bold text-white shadow-sm shadow-amber-500/30 transition-colors"
              >
                Restablecer PIN
              </button>
            </div>
